package pers.xuliushen.expresssation_io.dao;


import pers.xuliushen.expresssation_io.pojo.Express;
import pers.xuliushen.expresssation_io.util.IOUtil;
...
public class ExpressDao {
    ...
    private static final String FILE_NAME = "express.txt";//整个项目存储数据的文件名称
    ...
    private void init(){
        try {
            ...
            if(object!=null && object instanceof List){
               expressList = (List<Express>) object;
            }
        } catch (IOException e) {
            System.out.println(e.getMessage());
...
//        expressList.add(new Express("YD001","韵达",123457,0,1));
    ...
    public Express add(Express e) throws Exception {
        ...
        e.setY(y);
        expressList.add(e);
        IOUtil.writeFile(expressList,FILE_NAME);//写入文件
        return e;
    }
